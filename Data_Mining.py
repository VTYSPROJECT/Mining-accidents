...
for line in Content.splitlines():
    ...
    if (re.search("([1][0-9]{3}|20[0-2][0-9])", line) and re.search("(işçi|kişi|madenci)", line)):
        ...
        numara = "([0-9]{1}|[0-9]{2}|[0-9]{3}|[0-9]{4}|[0-9]{5}|[0-9]{6}|[0-9]{1}[.|,][0-9]{3}|[0-9]{2}[.|,][0-9]{3}|[0-9]{3}[.|,][0-9]{3}|[0-9] bini)"
        ...
        ay=r"[0-9]{2} (ocak|şubat|mart|nisan|mayıs|haziran|temmuz|ağustos|eylül|ekim|kasım|aralık+)"
        try:
